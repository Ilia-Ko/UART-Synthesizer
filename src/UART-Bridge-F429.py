...
class MyCompleter(object):  # Custom tab-completer
...
def PlayAudio(p, fPath):
    ...
    print(f"  Audio resampled: {strCh} {sampWd*8}-bit {fRate} Hz, bitrate = {nChan*8*sampWd*fRate/1000:.3f} kbit/s")
    ...
    # VI. Enter play mode and stream audio data
    print("\n  Please, press BLUE USER BUTTON to stop audio streaming.")
    p.write(b'play\r')
